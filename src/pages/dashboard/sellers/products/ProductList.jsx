...
const orderColumns = [
  { key: "checkbox", type: "checkbox" }, // special column
  ...
  { key: "date", label: "Date" },
  { key: "type", label: "Type" },
  { key: "status", label: "Status" }, // special badge styling
  { key: "actions", type: "actions" }, // special actions
];
...
export const ProductList = () => {
  return (
    ...
    <ProductTable columns={orderColumns} data={orders} />
        </div>
      </main>
    </div>
  );

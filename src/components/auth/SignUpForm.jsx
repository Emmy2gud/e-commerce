    ...
    <div>  <div>
         ...
         <form className="flex flex-col gap-6">
          ...
          <div className="grid gap-6">
              ...
              <Input id="username" type="text" placeholder="m@example.com" required className="border-1 border-gray-400 shadow-lg shadow-gray-200  " />
            </div>
            <div className="grid gap-3">
            ...
            <div className="grid gap-3">
              <div className="flex items-center">
                <Label htmlFor="password" className="font-semibold text-xs">Confirm Password</Label>
            ...
            <Button variant="outline" className="w-full border-gray-300 shadow-lg shadow-gray-200 hover:bg-gray-100 font-medium">
